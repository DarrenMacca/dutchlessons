...
A1: [
    ...
    { nl: "goedemorgen meneer", en: "Good morning, sir." },
    { nl: "goedemiddag mevrouw", en: "Good afternoon, ma'am." },
    { nl: "goedenavond familie", en: "Good night, family." },
    { nl: "tot ziens mijn vriend", en: "Goodbye, my friend." },
    { nl: "ik ben heel blij vandaag", en: "I am very happy today." },
    { nl: "hoe gaat het met hem", en: "How is he?" },
    { nl: "hoe gaat het met haar", en: "How is she?" },
    { nl: "hallo goedemorgen", en: "Hello, good morning." },
    { nl: "tot ziens meneer", en: "Goodbye, sir." },

    // Travel, Transit & Essential Needs
    { nl: "ik wil graag water alsjeblieft", en: "I would like water, please." },
    { nl: "ik wil graag bier alsjeblieft", en: "I would like beer, please." },
    { nl: "waar is de badkamer", en: "Where is the bathroom?" },
    { nl: "waar is het hotel", en: "Where is the hotel?" },
    { nl: "het hotel is dichtbij", en: "The hotel is near." },
    { nl: "waar is het station", en: "Where is the station?" },
    { nl: "waar is de trein", en: "Where is the train?" },
    { nl: "waar is de bus", en: "Where is the bus?" },
    { nl: "waar is het vliegveld", en: "Where is the airport?" },
    { nl: "waar is het ticket", en: "Where is the ticket?" },

    // Daily Routines, Work & Study
    { nl: "ik wil een koffie", en: "I want a coffee." },
    { nl: "de koffie is heet", en: "The coffee is hot." },
    { nl: "ik wil meer studeren", en: "I want to study more." },
    { nl: "ik wil meer werken", en: "I want to work more." },
    { nl: "ik wil boeken lezen", en: "I want to read books." },
    { nl: "ik wil boeken schrijven", en: "I want to write books." },
    { nl: "ik wil naar huis gaan", en: "I want to go home." },
    { nl: "ik wil rusten", en: "I want to rest." },
    { nl: "ik wil het huis schoonmaken", en: "I want to clean the house." },
    { nl: "ik wil vandaag koken", en: "I want to cook today." },
    { nl: "ik ben aan het leren", en: "I am learning." },
    { nl: "hij repareert de televisie", en: "He is fixing the television." },
    { nl: "wij zijn klaar", en: "We are ready." },
    { nl: "het uur is dichtbij", en: "The hour is near." },

    // Family, Home Life & Food Transactions
    { nl: "zij is mijn zus", en: "She is my sister." },
    { nl: "ik heb twee broers", en: "I have two brothers." },
    { nl: "mijn vriend is heel blij", en: "My friend is very happy." },
    { nl: "wij hebben honger", en: "We have hunger." },
    { nl: "zij hebben een groot huis", en: "They have a big house." },
    { nl: "het eten is goed", en: "The food is good." },
    { nl: "ik wil brood en melk", en: "I want bread and milk." },
    { nl: "biefstuk met patat alsjeblieft", en: "Steak with french fries, please." },
    { nl: "rijst zonder bonen", en: "Rice without beans." },
    { nl: "ik vind koude thee lekker", en: "I like cold tea." },
    { nl: "zij vinden kaas en eieren lekker", en: "They like cheese and eggs." },
    { nl: "wij vinden deze plek leuk", en: "We like this place." }
],

A2: [
    // Time Sequences, Indicators, and Routines
    { nl: "normaal gesproken sta ik vroeg op", en: "Normally I get up early." },
    { nl: "ik wil nu het avondeten koken", en: "I want to cook dinner now." },
    { nl: "zij leert nu snel", en: "She is learning fast now." },
    { nl: "hij wil het huiswerk vroeg afmaken", en: "He wants to finish homework early." },
    { nl: "zij willen nu informatie", en: "They want information now." },
    { nl: "de film eindigt over tien minuten", en: "The movie finishes in ten minutes." },
    { nl: "ik heb nu vijftien minuten", en: "I have fifteen minutes now." },
    { nl: "gisteravond was ik blij", en: "Anoche I was happy." },
    { nl: "eerst wil ik ontbijt", en: "Before, I want breakfast." },
    { nl: "zij heeft het huiswerk al afgemaakt", en: "She already finished homework." },
    { nl: "ik heb nog steeds problemen", en: "I still have problems." },

    // Household Actions, Cooking, and Spaces
    { nl: "de keuken is nu schoon", en: "The kitchen is clean now." },
    { nl: "open het keukenraam alsjeblieft", en: "Open the kitchen window, please." },
    { nl: "ik wil vandaag een nieuw ontbijt proberen", en: "I want to try a new breakfast today." },
    { nl: "ik wil nu het raam repareren", en: "I want to fix the window now." },
    { nl: "hij repareert de televisie in het huis", en: "He is fixing the television in the house." },
    { nl: "wij hebben eten voor lunch en diner", en: "We have food for lunch and dinner." },

    // Family Transactions & Travel Contexts
    { nl: "wij willen vandaag onze ouders bezoeken", en: "We want to visit parents today." },
    { nl: "waar is mijn vriend ik wil wachten", en: "Where is my friend? I want to wait." },
    { nl: "ik wil naar het vliegveld rijden", en: "I want to drive to the airport." },

    // Messages, Information & Communication Loops
    { nl: "ik wil nu het bericht lezen", en: "I want to read the message now." },
    { nl: "zij wil een bericht schrijven", en: "She wants to write a message." },
    { nl: "hij wil meer informatie alsjeblieft", en: "He wants more information, please." },
    { nl: "vergeet het bericht niet", en: "Don't forget the message." },

    // Travel Logistics, Apparel, & Social Scenarios
    { nl: "waar is het vliegtuig het is laat", en: "Where is the plane? It is late." },
    { nl: "het vliegtuig komt over twintig minuten aan", en: "The plane arrives in twenty minutes." },
    { nl: "ik heb vervoer naar het station nodig", en: "I need transport to the station." },
    { nl: "zij willen het hotel vroeg verlaten", en: "They want to leave the hotel early." },
    { nl: "wij kwamen aan dichtbij de nieuwe plek", en: "We arrived near the new place." },
    { nl: "ik wil nieuwe schoenen voor de reis", en: "I want new shoes for the trip." },
    { nl: "zij vindt haar kleine schoenen leuk", en: "She likes her small shoes." },
    { nl: "vaak vindt hij dit schone huis leuk", en: "Often, he likes this clean house." },

    // Number Assemblies & Quantities
    { nl: "ik heb elf nieuwe boeken", en: "I have eleven new books." },
    { nl: "er zijn twaalf bussen op het station", en: "There are twelve buses in the station." },
    { nl: "dertien minuten om af te maken", en: "Thirteen minutes to finish." },
    { nl: "veertien vis en rijst alsjeblieft", en: "Fourteen fish and rice, please." },
    { nl: "wij hebben vijftien eieren voor het ontbijt", en: "We have fifteen eggs for breakfast." },
    { nl: "zij heeft zestien appels", en: "She has sixteen apples." },
    { nl: "zeventien treinkaartjes alsjeblieft", en: "Seventeen train tickets, please." },
    { nl: "achttien bieren voor het huis", en: "Eighteen beers for the house." },
    { nl: "negentien mensen studeren hier", en: "Nineteen people study here." },
    { nl: "twintig minuten om te rusten", en: "Twenty minutes to rest." }
],


B1: [
    // Present Perfect & Continuous Actions
    { nl: "ik ben hier een maand geweest", en: "I have been here for a month." },
    { nl: "jij hebt snel geleerd tijdens de reis", en: "You have learned fast during the trip." },
    { nl: "hij heeft vandaag hard gewerkt", en: "He has worked hard today." },
    { nl: "wij hebben de ervaringen uit het verleden bestudeerd", en: "We have studied the past experiences." },
    { nl: "zij hebben hier twee jaar gewoond", en: "They have lived here for two years." },
    { nl: "zij is nu in de keuken aan het werken", en: "She is working in the kitchen now." },
    { nl: "wij studeren om onze vaardigheden te verbeteren", en: "We are studying to improve our skills." },
    { nl: "hij leest een nieuw boek terwijl hij wacht", en: "He is reading a new book while waiting." },
    { nl: "zij wonen in een kleine plek dichtbij de school", en: "They are living in a small place near school." },

    // Daily Life Management, Communication & Improvement
    { nl: "ik wil mijn communicatieve vaardigheden verbeteren", en: "I want to improve my communication skills." },
    { nl: "wij moeten vandaag de gesprekken voortzetten", en: "We need to continue the conversations today." },
    { nl: "ik wil de ervaringen uit het verleden begrijpen", en: "I want to understand the past experiences." },
    { nl: "zij wil nu de informatie herzien", en: "She wants to review the information now." },
    { nl: "hij moet het dagelijkse huiswerk voorbereiden", en: "He needs to prepare the daily homework." },
    { nl: "zij willen de regels volgen na de lunch", en: "They want to follow the rules after lunch." },
    { nl: "ik wil een ticket voor de reis krijgen", en: "I want to get a ticket for the trip." },
    { nl: "wij moeten de dagelijkse routine veranderen", en: "We need to change the daily routine." },
    { nl: "echter, ik begrijp jouw problemen", en: "However, I understand your problems." },

    // Restaurant Transactions & Food Contexts
    { nl: "waar is het nieuwe restaurant", en: "Where is the new restaurant?" },
    { nl: "breng het menu alsjeblieft", en: "Bring the menu, please." },

    // Restaurant Billings, Logistics & Connections
    { nl: "breng de rekening naar de tafel alsjeblieft", en: "Bring the bill to the table, please." },
    { nl: "de rekening is groot na het diner", en: "The bill is big after dinner." },
    { nl: "ik wil het menu van het restaurant begrijpen", en: "I want to understand the restaurant menu." },

    // Travel Logistics, Planning & Household Shifting
    { nl: "ik wil een nieuwe reis plannen", en: "I want to plan a new trip." },
    { nl: "zij willen een hotel vinden dichtbij het station", en: "They want to find a hotel near the station." },
    { nl: "zij moet haar treinkaartje annuleren", en: "She needs to cancel her train ticket." },
    { nl: "hij wil zijn ouders meenemen op de reis", en: "He wants to bring his parents on the trip." },
    { nl: "wij zijn van plan deze maand te verhuizen", en: "We plan to move house this month." },
    { nl: "zij willen vandaag met onze reis meegaan", en: "They want to join our trip today." },
    { nl: "waar kan ik nu vervoer vinden", en: "Where can I find transport now?" },
    { nl: "het vliegtuig werd gisteravond geannuleerd", en: "The plane was canceled last night." },

    // Timeline Scales, Numbers & Duration Indicators
    { nl: "hij heeft een uur gestudeerd tijdens de lunch", en: "He studied for an hour during lunch." },
    { nl: "zij werkt hier al een maand", en: "She has been working here for a month." },
    { nl: "zij wonen al tien jaar in dit huis", en: "They have lived in this house for ten years." },
    { nl: "ik moet alles herzien na deze maand", en: "I need to review everything after this month." },
    { nl: "wij willen de reis voorbereiden gedurende de maand", en: "We want to prepare the trip during the month." },
    { nl: "hij heeft dit jaar veel geleerd over vaardigheden", en: "He has learned a lot about skills this year." },
    { nl: "zij wil eerder informatie krijgen over het hotel", en: "She wants to get information about the hotel before." },
    { nl: "zij zullen doorgaan met studeren na twee jaar", en: "They will continue studying after two years." },
    { nl: "tijdens het studeren wil ik dagelijks verbeteren", en: "While studying, I want to improve daily." }
],

B2: [
    // Professional Strategies, Abstract Processes, and Analysis
    { nl: "zij willen de situatie analyseren", en: "They want to analyze the situation." },
    { nl: "wij moeten de risico's zorgvuldig evalueren", en: "We need to evaluate the risks carefully." },
    { nl: "hoewel het moeilijk was, heeft zij de taak afgemaakt", en: "Although it was difficult, she finished the task." },
    { nl: "zij betoogden dat het plan niet realistisch was", en: "They argued that the plan was not realistic." },
    { nl: "de strategie heeft onze prestatie-resultaten verhoogd", en: "The strategy has increased our performance results." },
    { nl: "daarom is het nodig om het risicoconcept te analyseren", en: "Therefore, it is necessary to analyze the risk concept." },
    { nl: "wij moeten een positieve strategie coördineren om resultaten te behalen", en: "We need to coordinate a positive strategy to achieve results." },
    { nl: "zij heeft haar innovatieve benadering verduidelijkt tijdens de discussie", en: "She has clarified her innovative approach during the discussion." },
    { nl: "ik wil het systeem bijwerken om onze vaardigheden te versterken", en: "I want to update the system to strengthen our skills." },
    { nl: "hij heeft elke mogelijkheid onderzocht om de taak te optimaliseren", en: "He has explored every possibility to optimize the task." },
    { nl: "zij betoogden dat een professionele aanpak nodig is", en: "They argued that a professional approach is necessary." },
    { nl: "wij hebben de ingewikkelde situatie opnieuw geanalyseerd", en: "We have analyzed the complicated situation again." },
    { nl: "zij heeft de strategie aangepast om de prestaties te verbeteren", en: "She has adapted the strategy to improve performance." },
    { nl: "ik wil nu een positieve benadering proberen", en: "I want to try a positive approach now." },
    { nl: "hij vergat de resultaten van het proces te controleren", en: "He forgot to check the results of the process." },
    { nl: "wij moeten de resultaten zorgvuldig analyseren", en: "We must analyze the results carefully." },
    { nl: "zij wil haar prestaties verbeteren", en: "She wants to improve her performance." },
    { nl: "wij moeten het systeem bijwerken", en: "We need to update the system." },
    { nl: "hij legde de strategie duidelijk uit", en: "He explained the strategy clearly." },
    { nl: "zij willen het proces optimaliseren", en: "They want to optimize the process." },

    // Abstract Milestones, Culture, and Challenges
    { nl: "wij gaan door zelfs als er uitdagingen zijn", en: "We will continue even if there are challenges." },
    { nl: "ondanks de problemen hebben zij de reis afgemaakt", en: "Despite the problems, they finished the trip." },
    { nl: "wij moeten ons aanpassen aan de nieuwe situatie", en: "We need to adapt to the new situation." },
    { nl: "zij wil haar professionele ervaring uitbreiden", en: "She wants to expand her professional experience." },
    { nl: "hij drong erop aan de gegevens opnieuw te bekijken", en: "He insisted on reviewing the data again." },
    { nl: "zij hopen betere resultaten te behalen", en: "They hope to achieve better results." },
    { nl: "wij moeten de instructies verduidelijken", en: "We need to clarify the instructions." },
    { nl: "hoewel het makkelijk lijkt, is het ingewikkeld", en: "Although it seems easy, it is complicated." },
    { nl: "zij betoogde dat de verandering nodig was", en: "She argued that the change was necessary." },
    { nl: "zij willen het communicatieproces versterken", en: "They want to strengthen the communication process." },
    { nl: "zij bespraken de situatie een uur tijdens de lunch", en: "They discussed the situation for an hour during lunch." },
    { nl: "zij wil leren over onze samenleving en cultuur", en: "She wants to learn about our society and culture." },
    { nl: "bovendien is motivatie nodig om doelen te bereiken", en: "In addition, motivation is necessary to achieve goals." },
    { nl: "de verwachtingen zijn hoog voor de toekomstige lange-termijnreis", en: "Expectations are high for the future long term trip." },
    { nl: "zij wonen op een afgelegen plek, maar studeren dagelijks", en: "They live in a remote place, however they study daily." },

    // Final Verification Loops & Resource Management
    { nl: "ik wil dit abstracte concept beter begrijpen", en: "I want to understand this abstract concept better." },
    { nl: "wij moeten ons voorbereiden op mogelijke systeemveranderingen", en: "We must prepare for possible system changes." },
    { nl: "zij willen de toegang tot informatie in de samenleving vergroten", en: "They want to increase information access in society." },
    { nl: "hij heeft het risico van de strategie verminderd", en: "He has reduced the risk of the strategy." }
]
};
